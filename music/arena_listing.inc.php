...
$obj_itemManager= new itemManager("LATEST",NULL,$databaseName,NULL,NULL,$limit,$page,"PUBLISHED",$seed);
$items=array();
$obj_itemManager->getItems($items);
for($i=0;$i<count($items);$i++)
{
?>							
					<div class="album-list  col_third  <?php if(($i+1)%3==0) echo "end";?>  " >
						...
						<div class="custompost_thumb port_img">
							...
							?>
                                ...
                                <span class="label-text">Unsigned</span>
...
<div class="album-list  col_third  <?php if(($i+2)%3==0) echo 'end';?>  " >
						<div class="custompost_entry">
						
						<div class="custompost_thumb port_img">
								<figure><a href="mailto:music@rayarc.ca?subject=Music%20Submission%20-%20Promote%20My%20Music">
                               
                                                                <img style="border:3px #CCC solid;width:100%;" src="images/graphics/promoteyourmusichere_470x470.jpg" alt="" title="Music Submission - Promote Your Music here" /></a></figure>
                                <div class="hover_type">
                                <a class="hoveraudio" href="mailto:music@rayarc.ca?subject=Music%20Submission%20-%20Promote%20My%20Music" title="Music Submission - Promote Your Music here"></a>
                                </div>
                                <span class="imgoverlay"></span>							
                        </div>
							...
							<div class="album-desc">
								...
								<h2 class="entry-title"><a href="mailto:music@rayarc.ca?subject=Music%20Submission%20-%20Promote%20My%20Music" rel="bookmark" title="Music Submission - Promote Your Music here">Your Music Track Title Here</a></h2>
								
								                                <span class="label-text"><a href="profile.php?pkey=0NFDIAP6">Artist Name Here</a></span>
                                <span class="label-text">Unsigned</span>
                                <span style="font-size:12px;">
											<span title='value is below our rating theshold>0'><I>Not Rated</I></span> 
                  </span>
							</div><!-- .album-desc-->
